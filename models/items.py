...
class O2_tank(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = ITEM_LAYER
        self.groups = self.game.all_sprites, self.game.o2_tank
        pygame.sprite.Sprite.__init__(self, self.groups)
        ...
        image_to_load = pygame.transform.scale(O2_TANK, (self.width, self.height))
